...
from django.contrib.auth.models import User # this and below are used to update the BookInstance Model class to add a ‘borrower’ field linked to Django’s User model
